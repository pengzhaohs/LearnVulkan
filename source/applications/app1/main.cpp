...
private:
    ...
    {
        auto vertShaderCode = readFile("shaders/vert_tex.spv");
        auto fragShaderCode = readFile("shaders/frag_tex.spv");
    ...
    void createTextureImage()
    {
        ...
        memcpy(data, pixels, static_cast<size_t>(imageSize)); vkUnmapMemory(device, stagingBufferMemory);
